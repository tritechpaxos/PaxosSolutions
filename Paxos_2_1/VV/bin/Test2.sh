...
echo
echo "VVAdmin CreateVolume NEW target 10000000 2 pool-0"
VVAdmin CreateVolume NEW target 10000000 2 pool-0
if [ ! $? ]; then exit 1; fi

echo
echo "VVAdmin CopyVolume TEST NEW"
VVAdmin CopyVolume TEST NEW

echo	"VVTest r target TEST 8388598 100 8388598 30"
VVTest r target NEW 8388598 100 8388598 30
if [ ! $? ]; then exit 1; fi
